            ...
            <div className='md:grid grid-cols-2 items-center gap-8 '>
                ...
                <div className='text-gray-700 text-lg leading-loose '>
                    <motion.div initial={{ opacity: 0, y: 120 }}
                        ...
                        viewport={{ once: true, amount: 0.3 }}
                        transition={{ duration: 0.6, ease: 'easeOut' }} className='bg-white border border-gray-200 px-5 py-6 rounded-xl shadow-md'>
                    ...
                    <motion.div initial={{ opacity: -5, y: 100 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.7, ease: 'easeOut' }}>
                        <Button className="mt-5 w-full">Babag 1, LLC</Button>
                    </motion.div>
                </div>
            </div>
        </section>
