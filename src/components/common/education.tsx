            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 p-3">
                    <motion.div className="h-full" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.6 }}>
                        <Card title="Bachelor of Information Technology" schoolDescription="Cordova Public College" buttonLabel="Currently" description="Pursuing a degree in Information Technology with a focus on software development." buttonVariant="primary" logo={CPC} logoAlt="Cordova Public College logo" />
                    </motion.div>
