...
export function Footer() {
  return (
    <footer className="bg-gray-50 border-t border-gray-200 mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              <motion.a initial={{opacity:-5, y:10}} animate={{opacity:1, y:1}} transition={{duration:0.7}} href="#"><img src="src\assets\icons\facebook.png" alt="Facebook" className="w-10 h-10 rounded-full border border-gray-400 bg-gray-100 p-2 hover:bg-gray-200 hover:scale-110 transition"/></motion.a>
              <motion.a initial={{opacity:-5, y:10}} animate={{opacity:1, y:1}} transition={{duration:0.8}} href="#"><img src="src\assets\icons\instagram.png" alt="insta" className="w-10 h-10 rounded-full border border-gray-400 bg-gray-100 p-2 hover:bg-gray-200 hover:scale-110 transition"/></motion.a>
              <motion.a initial={{opacity:-5, y:10}} animate={{opacity:1, y:1}} transition={{duration:0.9}} href="#"><img src="src\assets\icons\github.png" alt="Facebook" className="w-10 h-10 rounded-full border border-gray-400 bg-gray-100 p-2 hover:bg-gray-200 hover:scale-110 transition"/></motion.a>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <NavLink to="/contact" className="text-gray-600 hover:text-green-700">Contact</NavLink>
          </div>

          <div className="space-y-4">
            <h3 className="font-bold text-lg">Contact</h3>
            <div className="flex items-center gap-4 bg-gray-100 rounded-xl shadow-md p-4">
            ...
            <div className="flex items-center gap-4 bg-gray-100 rounded- shadow-md xl p-4">
              <div className="w-12 h-12 bg-gray-200 rounded-xl flex items-center justify-center text-white text-xl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-gray-400">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-5 border-t ">
