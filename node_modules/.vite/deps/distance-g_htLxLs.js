...
//#endregion
export { HTMLVisualElement as $, removeItem as $i, applyGeneratorOptions as $n, px as $r, isElementTextInput as $t, removeBoxTransforms as A, backOut as Ai, isMotionValue as An, createGeneratorEasing as Ar, setFeatureDefinitions as At, copyAxisDeltaInto as B, progress as Bi, getDefaultTransition as Bn, mixVisibility as Br, isAnimationControls as Bt, axisEquals as C, easeOut as Ci, animateTarget as Cn, keyframes as Cr, convertBoundingBoxToBox as Ct, isDeltaZero as D, anticipate as Di, camelToDash as Dn, interpolate as Dr, DOMVisualElement as Dt, boxEqualsRounded as E, circOut as Ei, optimizedAppearDataId as En, fillOffset as Er, Feature as Et, calcRelativeAxis as F, warnOnce as Fi, resolveVariantFromProps as Fn, getMixer as Fr, isControllingVariants as Ft, getVariantContext as G, isObject as Gi, motionValue as Gn, hslaToRgba as Gr, createDelta as Gt, copyBoxInto as H, noop as Hi, resolveTransition as Hn, mixLinearColor as Hr, createAxis as Ht, calcRelativeAxisPosition as I, velocityPerSecond as Ii, getVariableValue as In, mixArray as Ir, isVariantNode as It, renderSVG as J, invariant as Ji, supportsBrowserAnimation as Jn, color as Jr, statsBuffer as Jt, SVGVisualElement as K, isNumericalString as Ki, calcChildStagger as Kn, analyseComplexValue as Kr, findValueType as Kt, calcRelativeBox as L, millisecondsToSeconds as Li, parseCSSVariable as Ln, mixComplex as Lr, variantPriorityOrder as Lt, calcAxisDelta as M, mirrorEasing as Mi, isKeyframesTarget as Mn, maxGeneratorDuration as Mr, hasReducedMotionListener as Mt, calcBoxDelta as N, cubicBezier as Ni, positionalKeys as Nn, generateLinearEasing as Nr, prefersReducedMotion as Nt, removeAxisDelta as O, backIn as Oi, addValueToWillChange as On, inertia as Or, VisualElement as Ot, calcLength as P, hasWarned as Pi, resolveVariant as Pn, mix as Pr, updateMotionValuesFromProps as Pt, buildSVGPath as Q, moveItem as Qi, NativeAnimation as Qn, progressPercentage as Qr, isElementKeyboardAccessible as Qt, calcRelativePosition as R, secondsToMilliseconds as Ri, animateMotionValue as Rn, mixObject as Rr, variantProps as Rt, axisDeltaEquals as S, easeInOut as Si, animateVariant as Sn, defaultEasing as Sr, hasTransform as St, boxEquals as T, circInOut as Ti, optimizedAppearDataAttribute as Tn, defaultOffset as Tr, transformBoxPoints as Tt, checkVariantsDidChange as U, memo as Ui, MotionValue as Un, mixNumber$1 as Ur, createAxisDelta as Ut, copyAxisInto as V, pipe as Vi, getValueTransition as Vn, mixColor as Vr, visualElementStore as Vt, createAnimationState as W, isZeroValueString as Wi, collectMotionValues as Wn, mixImmediate as Wr, createBox as Wt, camelCaseAttributes as X, clamp as Xi, makeAnimationInstant as Xn, degrees as Xr, isSVGElement as Xt, isSVGTag as Y, warning as Yi, acceleratedValues as Yn, hsla as Yr, resize as Yt, buildSVGAttrs as Z, addUniqueItem as Zi, NativeAnimationExtended as Zn, percent as Zr, press as Zt, animateSingleValue as _, stepsOrder as _i, transformValueTypes as _n, readTransformValue as _r, transformAxis as _t, DocumentProjectionNode as a, alpha as ai, isDragging as an, supportsLinearEasing as ar, correctBorderRadius as at, eachAxis as b, isEasingArray as bi, testValueType as bn, animateValue as br, has2DTranslate as bt, propagateDirtyNodes as c, containsCSSVariable as ci, isHTMLElement as cn, supportsFlags as cr, buildHTMLStyles as ct, resolveMotionValue as d, time as di, cornerRadiusProps as dn, KeyframeResolver as dr, measureViewportBox as dt, vh as ei, isPrimaryPointer as en, isGenerator as er, scrapeMotionValuesFromProps$1 as et, delay as f, cancelFrame as fi, DOMKeyframesResolver as fn, flushKeyframeResolvers as fr, applyAxisDelta as ft, addDomEvent as g, createRenderBatcher as gi, numberValueTypes as gn, parseValueFromTransform as gr, scalePoint as gt, compareByDepth as h, frameSteps as hi, getDefaultValueType as hn, defaultTransformValue as hr, applyTreeDeltas as ht, rootProjectionNode as i, rgba as ii, isDragActive as in, cubicBezierAsString as ir, correctBoxShadow as it, removePointDelta as j, reverseEasing as ji, setTarget as jn, calcGeneratorDuration as jr, initPrefersReducedMotion as jt, removeAxisTransforms as k, backInOut as ki, isWillChangeMotionValue as kn, spring as kr, getFeatureDefinitions as kt, globalProjectionState as l, isCSSVariableName as li, getValueAsType as ln, setStyle as lr, buildTransform as lt, FlatTree as m, frameData as mi, defaultValueTypes as mn, transformProps as mr, applyPointDelta as mt, distance2D as n, hex as ni, hover as nn, mapEasingToNativeEasing as nr, addScaleCorrector as nt, cleanDirtyNodes as o, number as oi, cancelMicrotask as on, supportsScrollTimeline as or, pixelsToPercent as ot, delayInSeconds as p, frame as pi, getAnimatableNone as pn, transformPropOrder as pr, applyBoxDelta as pt, scrapeMotionValuesFromProps as q, MotionGlobalConfig as qi, AsyncMotionValueAnimation as qn, complex as qr, isSVGSVGElement as qt, HTMLProjectionNode as r, rgbUnit as ri, setDragLock as rn, supportedWaapiEasing as rr, scaleCorrectors as rt, createProjectionNode as s, scale as si, microtask as sn, supportsViewTimeline as sr, renderHTML as st, distance as t, vw as ti, isNodeOrChild as tn, startWaapiAnimation as tr, isForcedMotionValue as tt, NodeStack as u, isCSSVariableToken as ui, resolveElements as un, isCSSVar as ur, measurePageBox as ut, mixValues as v, easingDefinitionToFunction as vi, dimensionValueTypes as vn, fillWildcards as vr, transformBox as vt, axisEqualsRounded as w, circIn as wi, getOptimisedAppearId as wn, convertOffsetToTimes as wr, convertBoxToBoundingBox as wt, aspectRatio as x, easeIn as xi, animateVisualElement as xn, getFinalKeyframe as xr, hasScale as xt, buildProjectionTransform as y, isBezierDefinition as yi, findDimensionValueType as yn, JSAnimation as yr, translateAxis as yt, isNear as z, SubscriptionManager as zi, isTransitionDefined as zn, invisibleValues as zr, isVariantLabel as zt };
